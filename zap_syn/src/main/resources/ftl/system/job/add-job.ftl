...
<div class="x-body">
  <form class="layui-form layui-form-pane" style="margin-left: 20px;">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" id="clazzPath" style="width: 400px;height:36px" name="clazzPath" lay-verify="clazzPath"  autocomplete="off" class="layui-input">
  ...
  $("#clazzPath").ligerComboBox(
      {
        ...
        renderItem: function (e)
        {
            ...
            out.push('<div class="desc">备注:' + data.classPath + '</div>');
            return out.join('');
        }
      }
  );
