...
<div class="x-nav">
  <div class="select">
    ...
    任务状态:
    <div class="layui-inline">
          <select name="status" class="layui-input" lay-filter="aihao" id="status" autocomplete="off">
            <option value=""></option>
...
<script type="text/html" id="toolBar">
 ...
 <script type="text/html" id="statustips">
  {{#  if(!d.status){ }}
    未启动
  {{# } else { }}
    启动
  ...
  layui.use('table', function () {
    ...
    table.render({
      ...
      , cols: [[
        ...
        , {field: 'clazzPath', title: '任务类', width: '25%', sort: true}
        , {field: 'status', title: '状态', width: '10%', sort: true,templet:"#statustips"}
    ...
    var $ = layui.$, active = {
      ...
      detail: function () {
        ...
        detail('查看任务信息', 'updateJob?id=' + data[0].id, 900, 550);
      }
    };
    ...
    $.ajax({
      ...
      success: function (d) {
        if(d.flag){
          ...
          layer.msg(d.msg,{icon:5,offset: 'rb',anim:2});
        }
      }
    });
  }
