...
<div class="layui-layout layui-layout-admin kit-layout-admin">
  <div class="layui-header">
    <div class="layui-logo">任务管理系统</div>
  ...
  <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
              <#--<li class="layui-nav-item">
                <a class="" href="javascript:;"><i aria-hidden="true" class="layui-icon">&#xe614;</i><span> 系统管理</span></a>
                <dl class="layui-nav-child">
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'menu/showMenu',icon:'&#xe62a;',title:'菜单管理',id:'1001'}">
                  <i class="layui-icon">&#xe62a;</i><span> 菜单管理</span></a>
              </dd>
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'/user/showUser',icon:'&#xe6af;',title:'用户管理',id:'1002'}">
                  <i class="layui-icon">&#xe6af;</i><span> 用户管理</span></a>
              </dd>
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'/role/showRole',icon:'&#xe613;',title:'角色管理',id:'1003'}">
                  <i class="layui-icon">&#xe613;</i><span> 角色管理</span></a>
              </dd>
                </dl>
              </li>-->
              <li class="layui-nav-itemed layui-nav-item">
                <a class="" href="javascript:;"><i aria-hidden="true" class="layui-icon">&#xe62c;</i><span> 系统监控</span></a>
                <dl class="layui-nav-child">
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'log/showLog',icon:'&#xe60a;',title:'系统日志',id:'2001'}">
                  <i class="layui-icon">&#xe60a;</i><span> 系统日志</span></a>
              </dd>
                <dd>
                    <a href="javascript:;" kit-target data-options="{url:'log/runLog',icon:'&#xe60a;',title:'运行日志',id:'2005'}">
                    <i class="layui-icon">&#xe60a;</i><span> 运行日志</span></a>
                </dd>
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'swagger-ui.html',icon:'&#xe64e;',title:'接口api',id:'2002'}">
                  <i class="layui-icon">&#xe64e;</i><span> 接口api</span></a>
              </dd>
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'/job/showJob',icon:'&#xe756;',title:'定时任务',id:'2003'}">
                  <i class="layui-icon">&#xe756;</i><span> 定时任务</span></a>
              </dd>
              <dd>
                <a href="javascript:;" kit-target data-options="{url:'druid/index.html',icon:'&#xe628;',title:'系统监控',id:'2004'}">
                  <i class="layui-icon">&#xe628;</i><span> 系统监控</span></a>
              </dd>
                </dl>
              </li>
  </ul>
